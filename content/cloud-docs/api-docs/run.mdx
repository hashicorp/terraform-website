...
| `force_canceled`       | If the run could not be canceled gracefully, and it was force-canceled by a workspace admin.                                                                                                                                                                                                                                                                                                                                       |
...
| `data.attributes.plan-only`                        | bool                 | (from configuration version)                       | Specifies if this is a [speculative, plan-only](/cloud-docs/run/modes-and-options#plan-only-speculative-plan) run that cannot be applied. Often used in conjunction with terraform-version in order to test whether an upgrade would succeed. |
...
| `data.attributes.allow-empty-apply`                | bool                 |                                                    | Specifies whether Terraform can apply the run even when the plan [contains no changes](/cloud-docs/run/modes-and-options#allow-empty-apply). Often used to [upgrade state](/cloud-docs/workspaces/state#upgrading-state) after upgrading a workspace to a new terraform version.                                                                     |
