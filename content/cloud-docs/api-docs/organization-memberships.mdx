...
-> **Note:** Once a user is a member of the organization, you can manage their team memberships using [the Team Membership API](/cloud-docs/api-docs/team-members).
...
-> **Note:** Organization membership management is restricted to members of the owners team, the owners [team API token](/cloud-docs/users-teams-organizations/api-tokens#team-api-tokens), and the [organization API token](/cloud-docs/users-teams-organizations/api-tokens#organization-api-tokens).
