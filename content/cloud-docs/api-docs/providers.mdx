...
Uploads a GPG Key to a private registry. The response will provide a "key-id" which is needed to [Create a Provider Version](#create-a-provider-version) (see below).
