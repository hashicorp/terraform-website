...
| ------- | -------------------------------------------------- | -------------------------------------------------------- |
| [200][] | [JSON API document][] (`type: "registry-modules"`) | Success                                                  |
...
| `data.attributes.registry-name` | string |         | Whether this is a publicly maintained module or private. Must be either `public` or `private`.                                                                                                         |
...
| `:registry_name`     | Whether this is a publicly maintained module or private. Must be either `public` or `private`.              |
