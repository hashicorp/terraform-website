...
If the organization is configured to [manage team membership through SSO](/cloud-docs/users-teams-organizations/single-sign-on#managing-team-membership-through-sso), users will be automatically added to teams corresponding to the groups they belong to in their SSO configuration.
