...
-> **API:** Refer to the [Organizations API](/cloud-docs/api-docs/organizations). <br/>
**Terraform:** Refer to the `tfe` provider's [`tfe_organization`](https://registry.terraform.io/providers/hashicorp/tfe/latest/docs/resources/organization) resource.
