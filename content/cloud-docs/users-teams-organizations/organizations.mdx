...
The Run Tasks page is for managing the tasks which are available for workspaces to consume.

See [Run Tasks](/cloud-docs/workspaces/settings/run-tasks) for more information.
