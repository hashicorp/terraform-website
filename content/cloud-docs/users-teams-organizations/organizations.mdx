...
Organizations are a shared space for [teams][] to collaborate on workspaces. An organization can have many [teams](/cloud-docs/users-teams-organizations/teams).
