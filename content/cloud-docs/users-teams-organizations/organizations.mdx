...
Task event hooks are reusable [run tasks](/cloud-docs/workspaces/settings/run-tasks) configurations that can be attached to any workspace in an organization.
