...
Server. Leave this page open in a browser tab. In the next step, you will
copy and paste the unique **Consumer Key** and **Public Key.**

**If you have your own _Consumer Key_ and _Public/Private Key_ from an existing
Application Link, then toggle the _Use Custom Keys_ and insert them.**
