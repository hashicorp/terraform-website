...
When non-global variable sets have conflicting variables, Terraform Cloud compares the variable set names, and uses values from the variable set with lexical predence. Lexical ordering follows UTF-8 character precedence rules.
