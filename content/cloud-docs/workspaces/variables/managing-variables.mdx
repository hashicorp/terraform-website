...
### Creating Variables
Once you have the proper [read and write variables permissions](/cloud-docs/users-teams-organizations/permissions#general-workspace-permissions), you can create and edit workspace-specific variables through:
