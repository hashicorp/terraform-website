...
Variable sets are only visible to members with the correct team allocation. This is members who are part of the [Owners Team](/cloud-docs/users-teams-organizations/permissions#organization-owners) or members of a team with [Manage Workspaces](/cloud-docs/users-teams-organizations/permissions#manage-workspaces) permissions assigned.
