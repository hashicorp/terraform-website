...
Terraform automatically detects [Terraform variables](/cloud-docs/workspaces/variables#terraform-variables) present in your configuration when you [create a new workspace](/cloud-docs/workspaces/creating) using the VCS workflow. To add additional Terraform or environment variables:
...
Terraform automatically detects [Terraform variables](/cloud-docs/workspaces/variables#terraform-variables) present in your configuration when you [create a new workspace](cloud-docs/workspaces/creating) using the VCS workflow. Terraform cannot complete runs until you enter values for those variables. To edit a variable:
