...
Terraform automatically detects undefined [Terraform variables](/cloud-docs/workspaces/variables#terraform-variables) without default values in your configuration when you [create a new workspace](/cloud-docs/workspaces/creating) using the VCS workflow. To add additional Terraform or environment variables:
