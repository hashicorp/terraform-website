...
-> **Note:** Public providers and modules are available in Terraform Enterprise v202012-1 and later. You will need to make sure access to registry.terraform.io and  https://yy0ffni7mf-dsn.algolia.net/ are allowed.

## Private Modules

[Private modules](/cloud-docs/registry/publish) are hosted on an organization's private registry and are only available to members of that organization. In Terraform Enterprise, they are also available to other organizations that are configured to [share modules](/enterprise/admin/application/module-sharing) with that organization.
