...
In addition to the [Registry Providers API](/cloud-docs/api-docs/private-registry/providers#delete-a-provider), you can delete providers or provider versions through the Terraform Cloud UI. To delete providers and versions in the UI:
