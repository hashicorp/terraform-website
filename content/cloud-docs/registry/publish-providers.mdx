...
1. Use the version menu to navigate to the version you want to check.
1. Open the **Manage Provider** menu and select **View release files**. The **Release Files** page appears containing lists of uploaded and missing files for the current version.
...
- Add, update, and delete GPG keys
- Add, update, and delete provider versions and platforms
- Add, update, and delete private providers
