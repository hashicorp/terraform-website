...
All members of an organization can view and use public providers and modules, but only members of the [owners team](/cloud-docs/users-teams-organizations/permissions#organization-owners) can add them to the private registry. Owners can add providers and modules through the UI as detailed below or through the [Registry Providers API](/cloud-docs/api-docs/providers) and the [Registry Modules API](/cloud-docs/api-docs/modules#create-a-module-with-no-vcs-connection-).
