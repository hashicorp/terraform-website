...
description: >-
  Terraform can load private modules from private registries via Terraform
  Cloud.
---
...
sources](/language/modules/sources), but those sources don't support [version
constraints](/language/modules/syntax#version) or a browsable
...
[Terraform Cloud's private module registry is documented here.](/cloud-docs/registry)
