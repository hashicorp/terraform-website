...
description: The Terraform Registry makes it simple to find and use modules.
---
...
By default, only [verified modules](/registry/modules/verified)
...
[Terraform Cloud's private registry is documented here.](/cloud-docs/registry)
...
[module version constraints](/language/modules/syntax#version) and
