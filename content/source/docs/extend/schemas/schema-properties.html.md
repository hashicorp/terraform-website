...
sidebar_current: "docs-extend-schemas-properties"
description: |-
  Extending Terraform is a section for content dedicated to developing Plugins
  to extend Terraform's core offering.
---

# Terraform Schemas Properties

*NOTE* should distinguish between `schema.Provider`, `schema.Resource`,
`schema.Schema`

Schema properties from
[`helper/schame/schema.go`](https://github.com/hashicorp/terraform/blob/master/helper/schema/schema.go#L37):
