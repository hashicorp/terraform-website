...
-> **Note**: This document applies to the standard AMI-based deliverable of Private Terraform Enterprise. If you are in the Installer, please see the [instructions for the Installer](./install-installer.html).
