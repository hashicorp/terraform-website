...
**Note**: Verify you are on release version 201807-2 or later, as that is the version that introduced the debugging functionality that is described in this guide. If you would like assistance with upgrading, please [contact support](/docs/enterprise/faq.html#support-for-terraform-enterprise).
...
If you're not able to resolve the error using the steps above, [reach out to support](/docs/enterprise/faq.html#support-for-terraform-enterprise). When contacting support, please provide:
