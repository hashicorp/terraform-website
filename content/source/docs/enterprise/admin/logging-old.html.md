...
This document contains information about interacting with Terraform Enterprise logs prior to release v202109-1. If you have updated to v202109-1 or later, please refer to the [latest version of this page](/docs/enterprise/admin/logging.html).
