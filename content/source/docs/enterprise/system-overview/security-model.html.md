...
In addition those provided in the [Terraform Cloud security model](/docs/cloud/architectural-overview/security-model.html), we recommend the following for Terraform Enterprise users.
