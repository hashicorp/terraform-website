...
- `tls_ver` - (Optional) Set to `tls_1_2` to enable only TLS 1.2, or to `tls_1_3` to enable only TLS 1.3. When unset, TFE defaults to both TLS 1.2 and 1.3 (`tls_1_2_tls_1_3`).
- `tls_ciphers` - (Optional) Set to an OpenSSL-format ciphersuite string to enable a custom TLS ciphersuite. When unset, TFE uses a default ciphersuite.
