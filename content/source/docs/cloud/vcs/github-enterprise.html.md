...
1. Create an SSH keypair on a secure workstation that Terraform Cloud can use to connect to GitHub Enterprise. The exact command depends on your OS, but is usually something like:
...
2. Logged into the GitHub Enterprise account you want Terraform Cloud to act as, navigate to the SSH Keys settings page, add a new SSH key and paste the value of the SSH public key you just created.
