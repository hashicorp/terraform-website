...
## Step 4: On Terraform Cloud, Set Up a PEM-encoded SSH Keypair (Optional)
...
### If You Don't Need a PEM-encoded SSH Keypair:
...
### If You Do Need aa PEM-encoded SSH Keypair:

1. On a secure workstation, create a PEM-encoded SSH keypair that Terraform Cloud can use to connect to GitLab. The exact command depends on your OS, but is usually something like:
