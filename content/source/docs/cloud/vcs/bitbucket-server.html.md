...
-> **Version note:** Terraform Cloud supports Bitbucket Server versions 4.9.1 and above, and Bitbucket Data Center versions 5.4.0 and above. HashiCorp does not test older versions of Bitbucket Server with Terraform Cloud, and they might not work as expected. Also note that, although we do not deliberately remove support for versions that have reached end of life (per the [Atlassian Support End of Life Policy](https://confluence.atlassian.com/support/atlassian-support-end-of-life-policy-201851003.html)), our ability to resolve customer issues with end of life versions might be limited.<br /><br />Terraform Cloud will soon deprecate support for Bitbucket Server versions 5.3.0 and below.
