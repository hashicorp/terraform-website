...
1. If it's your first Azure DevOps application open [Register new application](https://app.vsaex.visualstudio.com/app/register) and go to the next step for provide the form informations else open your [Azure DevOps Services Profile](https://aex.dev.azure.com) in a browser tab; log in to your Azure DevOps Services account if necessary.
