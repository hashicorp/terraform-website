...
sensitive data if at all possible. Access to this information requires the
[download Sentinel mocks permission](../users-teams-organizations/permissions.html)
on the workspace where the data was generated.
...
* You do not have the
  [download Sentinel mocks permission](../users-teams-organizations/permissions.html)
  on the workspace. This is to protect the possibly sensitive data which can be
