...
The **Variables** page appears, showing all workspace-specific variables and variable sets applied to the workspace. On the **Variables** page you can add, edit, and delete workspace-specific variables. You can also add and remove variable sets from this workspace.
