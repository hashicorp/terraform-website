...
Terraform Cloud's private module registry helps you share [Terraform modules](/docs/language/modules/develop/index.html) across your organization. It includes support for module versioning, a searchable and filterable list of available modules, and a configuration designer to help you build new workspaces faster.
