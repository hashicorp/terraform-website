...
All members of an organization can view modules. <!-- permissions -->

Only members of the "owners" team can publish new modules. Once a module is published, the ability to release new versions is managed by your VCS provider.  <!-- permissions -->
