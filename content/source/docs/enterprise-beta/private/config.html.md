...
it can send emails and SMS, and connect to your git hosting provider.
...
**Note:** Please substitute the hostname for your Private Terraform Enterprise installation in place of
`tfe.example.com`.
...
1. Fill in HTTP URL and API URL in Terraform Enterprise for your git provider
...
Remember to replace `tfe.example.com` with your Private Terraform Enterprise hostname.
