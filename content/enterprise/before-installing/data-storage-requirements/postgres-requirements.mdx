...
-> **Note:** These requirements apply to the External Services operational mode, not the Mounted Disk operational mode. See the [Pre-Install Checklist](/enterprise/before-installing) for more information.
