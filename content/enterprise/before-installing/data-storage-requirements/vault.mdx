...
The backup process requires additional permissions when migrating from an externally managed Vault service to the internal Terraform Enterprise Vault service. Modify the Vault policy to provide read access to the following paths. 
