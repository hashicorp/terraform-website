...
Snapshots`. The interval depends on the operational mode. We recommend Daily
for _Mounted Disk_ or _External Services_ because the snapshots contain only
configuration data, not application data.
