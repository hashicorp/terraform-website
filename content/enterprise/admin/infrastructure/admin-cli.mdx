...
-> **Note**: Admin CLI commands are available on the Standalone installation in Terraform Enterprise version v202203-1 and later.
...
This command generates a support bundle for all nodes in `/var/lib/replicated/support-bundles`.
