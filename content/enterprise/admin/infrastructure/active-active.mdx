...
~> **Note:** Clustering is no longer supported and we strongly advise all customers to move to an Active/Active installation. Contact your support representative if you need assistance.
