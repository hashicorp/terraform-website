...
Yes, this is the recommended option. Docker CE is compatible with Terraform Enterprise, and tested every night. It is not directly [supported by RedHat](https://access.redhat.com/articles/2726611). This a robust open source community, however.
