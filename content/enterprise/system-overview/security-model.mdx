...
Infrastructure admins are responsible for all aspects of reliability and availability. Refer to Terraform Enterprise documentation on [monitoring](/enterprise/admin/infrastructure/monitoring), [backups and restores](/enterprise/admin/infrastructure/backup-restore), and [high availability mode (active/active)](/enterprise/admin/infrastructure/active-active) for more guidance on this topic.
