...
1. Prepare some required Azure infrastructure.
...
* An Azure Database for PostgreSQL - please see [PostgreSQL Requirements](/enterprise/before-installing/data-storage-requirements/postgres-requirements).
...
1. Create a new Terraform configuration that calls the `hashicorp/terraform-enterprise/azurerm` module:
