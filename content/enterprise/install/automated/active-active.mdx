...
* [New CLI-based commands](/enterprise/admin/infrastructure/admin) vs Replicated Admin Console for administration
...
See [Admin Administration](/enterprise/admin/infrastructure/admin) for more status and troubleshooting commands.
