...
Rarely, certain types of workloads by cause spikes in the Redis server CPU or memory. We recommend the Redis server be monitored and scaled up as necessary. 
