...
* [CLI-based commands](/enterprise/admin/infrastructure/admin) for administration instead of the Replicated Admin Console
...
See [Admin CLI Commands](/enterprise/admin/infrastructure/admin) for more status and troubleshooting commands.
