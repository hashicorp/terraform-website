...
- `enable_metrics_collection` — Whether Terraform Enterprise's [internal metrics collection](/enterprise/admin/infrastructure/monitoring#internal-monitoring) should be enabled; defaults to `true`.
