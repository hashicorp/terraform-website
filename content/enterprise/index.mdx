...
The **Application Usage** section of the Terraform Enterprise documentation is intended for application end users. It is the same content as the [Terraform Cloud documentation](/cloud) because the application is shared between both products.
