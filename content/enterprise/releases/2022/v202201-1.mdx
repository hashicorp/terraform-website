...
1. The [new `tfe-admin rotate-encryption-password` command](https://www.terraform.io/enterprise/admin/infrastructure/admin) rotates the encryption password on active/active installations of Terraform Enterprise.
