...
1. The [new `tfe-admin rotate-encryption-password` command](https://www.terraform.io/enterprise/admin/infrastructure/admin-cli) rotates the encryption password on Active/Active installations of Terraform Enterprise.
