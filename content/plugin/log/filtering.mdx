...
You can pass the following values to each logging environment variable to set the verbosity level of its log output. They are listed in order of least verbose to most verbose:
