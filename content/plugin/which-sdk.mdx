...
If you maintain a large existing provider, we recommend that you begin migrating from SDKv2 to the framework by developing new resources and data sources with the framework. You can use [terraform-plugin-mux](./mux) to refactor the provider over time. Refer to the [Migrate to Terraform Plugin Framework](./sdkv2/sdkv2-intro#migrate-to-terraform-plugin-framework) documentation for more details.
