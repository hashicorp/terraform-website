...
* Support multiple provider SDK implementations. For example, you could upgrade an existing [terraform-plugin-sdk/v2](/plugin/sdkv2/sdkv2-intro) provider to protocol version 6 and then combine it with one or more providers built with [terraform-plugin-framework](/plugin/framework).
...
* [tf5to6server](/plugin/mux/translating-protocol-version-5-to-6): Translate protocol version 5 providers into protocol version 6.
