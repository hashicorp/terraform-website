...
* Migrate individual resources and data sources from [terraform-plugin-sdk/v2](/plugin/sdkv2/sdkv2-intro) to [terraform-plugin-framework](/plugin/framework) over time, while using protocol version 6 features in terraform-plugin-framework.
* Develop with [terraform-plugin-sdk/v2](/plugin/sdkv2/sdkv2-intro), but require Terraform CLI 1.0 or later.
