...
* Migrate individual resources and data sources from [terraform-plugin-sdk/v2](/plugin/sdkv2/sdk-intro) to [terraform-plugin-framework](/plugin/framework) over time, while maintaining Terraform CLI 0.12 and later compatibility.
...
* [terraform-plugin-framework](/plugin/framework): Develop Terraform providers with a higher-level SDK.
