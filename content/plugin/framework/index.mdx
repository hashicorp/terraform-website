...
The plugin framework is a new way to develop Terraform Plugins on [Protocol Version 6](/plugin/how-terraform-works#terraform-plugin-protocol). It offers improvements and new features from [Teraform Plugin SDKv2](/plugin/sdkv2/sdkv2-intro).

~> **Important**: [Which SDK Should I Use?](/plugin/which-sdk) explains the differences between [Teraform Plugin SDKv2](/plugin/sdkv2/sdkv2-intro) and Terraform Plugin Framework to help you decide which option is right for your provider.
...
* [Combine your provider](../mux/combine-protocol-version-6-providers) with other [protocol version 6](../how-terraform-works#protocol-version-6) providers.
* [Translate your provider](../mux/translate-protocol-version-6-to-5) into a [protocol version 5](../how-terraform-works#protocol-version-5) provider for compatibility with Terraform 0.12 and later. [Protocol version 6](../how-terraform-works#protocol-version-6) features cannot be used.
