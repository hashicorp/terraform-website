...
The plugin framework is a new way to develop Terraform Plugins on [Protocol Version 6](../how-terraform-works#terraform-plugin-protocol). It offers improvements and new features from [Teraform Plugin SDKv2](/plugin/sdkv2/sdkv2-intro).
...
* [Translate your provider](../mux/translate-protovol-version-6-to-5) into a [protocol version 5](../how-terraform-works#protocol-version-5) provider for compatibility with Terraform 0.12 and later. [Protocol version 6](../how-terraform-works#protocol-version-6) features cannot be used.
